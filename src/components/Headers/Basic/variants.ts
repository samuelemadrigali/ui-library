...
export const headerBasicVariants = tv({
  slots: {
    header: [
    ...
    desktopNav: ["hidden items-center gap-6"],
    mobileMenuButton: ["flex items-center"],
    overlay: [
